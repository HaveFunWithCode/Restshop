...
class productUnitJsonForm(forms.ModelForm):
    ...
    def __init__(self, *args,**kwargs):
        ...
        enumfields=[[a,DATA_SCHEMA["properties"][a]['enum']] for a in DATA_SCHEMA["properties"] if 'enum' in DATA_SCHEMA["properties"][a] ]
...
class productUnitInline(admin.StackedInline):
    ...
    # productUnitinlineFormSet = inlineformset_factory(Product,ProductUnit, form=productUnitJsonForm,
    #     fields=("variant","variant_title","seller","price","storage_count"))
